...
import com.me.pipelinedetectionapp.ui.CollecDataActivity;
 ...
 */
public class FunctionAdapter2 extends RecyclerView.Adapter<FunctionAdapter2.ViewHolder> {
    private Context context;
    private LayoutInflater mInflater;
    private List<PipePSCheckDb> _arrayList;
    private final static SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DateTimeUtil.DATE_FORMAT_YYYYMMDD_HHMMSS);

    public FunctionAdapter2(Context context, List<PipePSCheckDb> arrayList) {
        this.context = context;
        this._arrayList = arrayList;
        this.mInflater = LayoutInflater.from(context);
    }

    public void setContentList(List<PipePSCheckDb> arrayList) {
        this._arrayList = arrayList;
    }
        ...
        if (_arrayList.size() != 0) {
            ...
            viewHolder.ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, CollecDataActivity.class);
                ...
                public boolean onLongClick(View v) {
                    ...
                    builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            PipePSCheckDb detectionDb = new PipePSCheckDb();
                            detectionDb.setId(Long.valueOf(id));
                            MyApplication.getApplication().getDaoSession().getPipePSCheckDbDao().queryBuilder()
                                    .where(PipePSCheckDbDao.Properties.Id.eq(id)).buildDelete().executeDeleteWithoutDetachingEntities();
